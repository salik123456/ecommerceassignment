...
const ProductCard = ({ product }) => {
  return (
    <div className='lg:w-[23%] w-[47%] mt-2 p-3'>
      ...
      <div className='product-desc flex text-center py-4   border-t-0 flex-col'>
        ...
        <div className='price-box mt-6 flex lg:flex-row flex-col items-center w-full mx-auto justify-between'>
          <p className='text-[#223263] font-bold text-md'>${product.price}</p>
          <p className='text-xs text-[#9098B1] lg:ml-4 '>{product.category}</p>
